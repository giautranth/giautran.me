...
function chihoi_enqueue_scripts() {
    ...
    wp_enqueue_style('chihoi-main-style', get_template_directory_uri() . '/css/style.css', array(), '3.6.0');
    wp_enqueue_style('chihoi-theme-style', get_stylesheet_uri(), array('chihoi-main-style'), '3.6.0');
    wp_enqueue_script('chihoi-main-script', get_template_directory_uri() . '/js/main.js', array(), '3.6.0', true);
}
