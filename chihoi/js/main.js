      ...
      if (title.includes('Ban Chấp hành') || title.includes('ra mắt')) {
        ...
        bodyHtml = `
          ...
          <div style="color: #334e68; font-size: 0.95rem; line-height: 1.8;">
            ...
            <p style="margin-bottom: 16px;">Các bệnh viện, phòng khám hội viên có nhu cầu tham gia phối hợp hoặc đăng ký hội viên chính thức vui lòng liên hệ Ban Thường Trực Chi hội qua Hotline: <strong>1800 9045</strong> hoặc email: <strong>info@chihoibenhvien.com</strong>.</p>
          </div>
        `;
      }
