<?php get_header(); ?>
  ...
  <!-- ========== 1.5. PHƯƠNG CHÂM HOẠT ĐỘNG: ĐOÀN KẾT - HỢP TÁC - PHÁT TRIỂN ========== -->
    ...
    <div class="container">
      <div class="core-values-grid">
        ...
        <div class="core-value-card">
          <div class="core-value-icon-box icon-doan-ket">
            <svg width="28" height="28" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24">
              <path stroke-linecap="round" stroke-linejoin="round" d="M17 20h5v-2a3 3 0 00-5.356-1.857M17 20H7m10 0v-2c0-.656-.126-1.283-.356-1.857M7 20H2v-2a3 3 0 015.356-1.857M7 20v-2c0-.656.126-1.283.356-1.857m0 0a5.002 5.002 0 019.288 0M15 7a3 3 0 11-6 0 3 3 0 016 0zm6 3a2 2 0 11-4 0 2 2 0 014 0zM7 10a2 2 0 11-4 0 2 2 0 014 0z" />
            </svg>
          </div>
          <div class="core-value-content">
            <h3 class="core-value-title">ĐOÀN KẾT</h3>
            <p class="core-value-desc">Gắn kết mạng lưới bệnh viện, phòng khám hội viên phía Nam thành khối thống nhất, tương trợ và đồng hành.</p>
          </div>
        </div>

        <!-- Box 2: HỢP TÁC -->
        <div class="core-value-card">
          <div class="core-value-icon-box icon-hop-tac">
            <svg width="28" height="28" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24">
              <path stroke-linecap="round" stroke-linejoin="round" d="M21 12a9 9 0 01-9 9m9-9a9 9 0 00-9-9m9 9H3m9 9a9 9 0 01-9-9m9 9c1.657 0 3-4.03 3-9s-1.343-9-3-9m0 18c-1.657 0-3-4.03-3-9s1.343-9 3-9m-9 9a9 9 0 019-9" />
            </svg>
          </div>
          <div class="core-value-content">
            <h3 class="core-value-title">HỢP TÁC</h3>
            <p class="core-value-desc">Hợp tác chuyên môn sâu, liên kết chuyển tuyến, chia sẻ nguồn lực y tế và đào tạo y khoa liên tục (CME).</p>
          </div>
        </div>

        <!-- Box 3: PHÁT TRIỂN -->
        <div class="core-value-card">
          <div class="core-value-icon-box icon-phat-trien">
            <svg width="28" height="28" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24">
          ...
          <div class="core-value-content">
            ...
            <p class="core-value-desc">Đổi mới quản trị bệnh viện, chuyển đổi số y tế, nâng cao chất lượng phục vụ và phát triển bền vững.</p>
          </div>
        </div>
