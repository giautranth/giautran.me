...
get_header(); ?>
  ...
  <main class="site-section">
    <div class="container">
      ...
      <!-- ========== LOGO SHOWCASE: HỘI VIÊN & ĐỐI TÁC ĐỒNG HÀNH (Infinite Loop) ========== -->
      <div style="margin-top:40px;overflow:hidden;">
        <div class="section-header-row" style="margin-bottom:16px;">
          <div>
            <div class="section-main-title" style="font-size:1.15rem;">HỘI VIÊN & ĐỐI TÁC ĐỒNG HÀNH</div>
            <div style="font-size:0.85rem;color:#64748b;margin-top:2px;">Mạng lưới các thương hiệu y tế uy tín và tập đoàn đồng hành</div>
          </div>
        </div>
