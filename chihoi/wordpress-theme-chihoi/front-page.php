  ...
  <section class="home-banner banner-slider aih-hero-banner-section">
    <div class="banner-carousel-wrapper">
      <div class="banner-slides-track">
        ...
        <!-- Slide 1: Nhận Diện Chi Hội (Desktop & Mobile Chuẩn AIH) -->
        <div class="banner-slide active" data-slide-index="0">
          <div class="image img-cover">
            <picture>
              <source media="(max-width: 767.98px)" srcset="photo/banner/banner_mobile.jpg">
              <img src="photo/banner/banner_main.jpg" alt="Chi hội Bệnh viện Tư nhân TP. Hồ Chí Minh và các tỉnh phía Nam - Nhiệm kỳ 2026 – 2029" class="banner-img" fetchpriority="high">
            </picture>
          </div>
        </div>

        <!-- Slide 2: Lễ Ra Mắt Ban Chấp Hành -->
        <div class="banner-slide" data-slide-index="1">
          <div class="image img-cover">
            <picture>
              <source media="(max-width: 767.98px)" srcset="photo/banner/banner_2_mobile.jpg">
              <img src="photo/banner/banner_2_desktop.jpg" alt="Lễ ra mắt Ban Chấp hành Chi hội Bệnh viện Tư nhân TP.HCM và các tỉnh phía Nam" class="banner-img">
            </picture>
          </div>
        </div>

        <!-- Slide 3: Diễn Đàn Y Tế Tư Nhân 2026 -->
        <div class="banner-slide" data-slide-index="2">
          <div class="image img-cover">
            <picture>
              <source media="(max-width: 767.98px)" srcset="photo/banner/banner_3_mobile.jpg">
              <img src="photo/banner/banner_3_desktop.jpg" alt="Diễn đàn Phát triển Y tế tư nhân Việt Nam năm 2026" class="banner-img">
            </picture>
          </div>
        </div>
      ...
      <div class="banner-pagination-dots">
        ...
        <button type="button" class="carousel-dot" data-slide-index="2" aria-label="Chuyển đến banner 3"></button>
      </div>
      ...
      <div class="section-slider-container">
        ...
        <div class="news-article-card" data-category="chi-hoi">
          ...
          <div class="news-card-body">
            ...
            <div class="news-card-footer">
              <a href="#" class="link-read-more btn-news-detail" data-news-id="news-1" data-news-title="Kết Nối Sức Mạnh Y Tế Tư Nhân Phía Nam: Madam Trần Thị Lâm Giữ Vai Trò Chủ Tịch Chi Hội" data-news-cat="CHI HỘI" data-news-date="21/07/2026">Xem thêm →</a>
            </div>
          </div>
        </div>
        ...
        <div class="news-article-card" data-category="su-kien">
          ...
          <div class="news-card-body">
            ...
            <div class="news-card-footer">
              <a href="#" class="link-read-more btn-news-detail" data-news-id="news-2" data-news-title="Ra Mắt Ban Chấp Hành Chi Hội Bệnh Viện Tư Nhân TP.HCM Và Các Tỉnh, Thành Phía Nam" data-news-cat="SỰ KIỆN" data-news-date="19/08/2026">Xem thêm →</a>
            </div>
          </div>
        </div>
        ...
        <div class="news-article-card" data-category="su-kien">
          ...
          <div class="news-card-body">
            ...
            <div class="news-card-footer">
              <a href="#" class="link-read-more btn-news-detail" data-news-id="news-3" data-news-title="Diễn Đàn Phát Triển Y Tế Tư Nhân Việt Nam Năm 2026 (Lần Thứ II) Thành Công Tốt Đẹp" data-news-cat="SỰ KIỆN" data-news-date="21/08/2026">Xem thêm →</a>
            </div>
          </div>
        </div>
      </div>
