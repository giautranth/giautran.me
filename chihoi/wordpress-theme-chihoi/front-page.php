      ...
      <div class="facilities-split-layout">
        ...
        <div class="facilities-split__left">
          <div class="facilities-main-view">
            <img id="facility-main-img" src="/photo/hinh-anh-video/2.jpg" alt="Hình ảnh Chi hội Bệnh viện Tư nhân" class="facility-main-image" style="display:block;" />
          </div>
        </div>
        ...
        <div class="facilities-split__right">
          <div class="facilities-side-grid">
            <div class="facility-side-card active" data-type="image" data-src="/photo/hinh-anh-video/2.jpg" onclick="switchFacilityMedia(this)">
              <img src="/photo/hinh-anh-video/2.jpg" alt="Hình ảnh Chi hội 2" loading="lazy" />
            </div>

            <div class="facility-side-card" data-type="image" data-src="/photo/hinh-anh-video/1.jpg" onclick="switchFacilityMedia(this)">
