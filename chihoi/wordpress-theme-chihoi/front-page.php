<?php get_header(); ?>
  ...
  <section class="site-section bg-subtle">
    <div class="container">
      ...
      <!-- ========== HÌNH ẢNH - VIDEO SECTION (Single Featured Video) ========== -->
  <section class="site-section bg-subtle">
    <div class="container">
      <div class="section-header-row" style="margin-bottom: 20px;">
        <div class="section-main-title">HÌNH ẢNH - VIDEO</div>
      </div>
      ...
      <div class="facilities-split-layout">
        ...
        <div class="facilities-split__left">
          <div class="facilities-main-view">
            <img id="facility-main-img" src="photo/hinh-anh-video/1.jpg" alt="Hình ảnh Chi hội Bệnh viện Tư nhân" class="facility-main-image" />
          </div>
        </div>
        ...
        <div class="facilities-split__right">
          <div class="facilities-side-grid">
            ...
            <div class="facility-side-card active" onclick="switchFacilityImg('photo/hinh-anh-video/1.jpg', this)">
              <img src="photo/hinh-anh-video/1.jpg" alt="Hình ảnh Chi hội 1" loading="lazy" />
            </div>

            <div class="facility-side-card" onclick="switchFacilityImg('photo/hinh-anh-video/2.jpg', this)">
              <img src="photo/hinh-anh-video/2.jpg" alt="Hình ảnh Chi hội 2" loading="lazy" />
            </div>

            <div class="facility-side-card" onclick="switchFacilityImg('photo/hinh-anh-video/3.jpg', this)">
              <img src="photo/hinh-anh-video/3.jpg" alt="Hình ảnh Chi hội 3" loading="lazy" />
            </div>

            <div class="facility-side-card" onclick="switchFacilityImg('photo/hinh-anh-video/4.jpg', this)">
              <img src="photo/hinh-anh-video/4.jpg" alt="Hình ảnh Chi hội 4" loading="lazy" />
            </div>

            <div class="facility-side-card" onclick="switchFacilityImg('photo/hinh-anh-video/5.jpg', this)">
              <img src="photo/hinh-anh-video/5.jpg" alt="Hình ảnh Chi hội 5" loading="lazy" />
            </div>

            <div class="facility-side-card" onclick="switchFacilityImg('photo/hinh-anh-video/6.jpg', this)">
              <img src="photo/hinh-anh-video/6.jpg" alt="Hình ảnh Chi hội 6" loading="lazy" />
            </div>

            <div class="facility-side-card" onclick="switchFacilityImg('photo/hinh-anh-video/7.jpg', this)">
              <img src="photo/hinh-anh-video/7.jpg" alt="Hình ảnh Chi hội 7" loading="lazy" />
            </div>

            <div class="facility-side-card" onclick="switchFacilityImg('photo/hinh-anh-video/8.jpg', this)">
              <img src="photo/hinh-anh-video/8.jpg" alt="Hình ảnh Chi hội 8" loading="lazy" />
            </div>

            <div class="facility-side-card" onclick="switchFacilityImg('photo/hinh-anh-video/9.jpg', this)">
              <img src="photo/hinh-anh-video/9.jpg" alt="Hình ảnh Chi hội 9" loading="lazy" />
            </div>

            <div class="facility-side-card" onclick="switchFacilityImg('photo/hinh-anh-video/10.jpg', this)">
              <img src="photo/hinh-anh-video/10.jpg" alt="Hình ảnh Chi hội 10" loading="lazy" />
            </div>

            <div class="facility-side-card" onclick="switchFacilityImg('photo/hinh-anh-video/11.jpg', this)">
              <img src="photo/hinh-anh-video/11.jpg" alt="Hình ảnh Chi hội 11" loading="lazy" />
            </div>

            <div class="facility-side-card" onclick="switchFacilityImg('photo/hinh-anh-video/12.jpg', this)">
