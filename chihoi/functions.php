...
function chihoi_enqueue_scripts() {
    ...
    wp_enqueue_style('chihoi-main-style', get_template_directory_uri() . '/css/style.css', array(), '3.7.0');
    wp_enqueue_style('chihoi-theme-style', get_stylesheet_uri(), array('chihoi-main-style'), '3.7.0');
    wp_enqueue_script('chihoi-main-script', get_template_directory_uri() . '/js/main.js', array(), '3.7.0', true);
}
...
// 2b. Thêm tiêu đề CỔNG QUẢN TRỊ WEBSITE bên dưới logo
add_filter('login_message', function($message) {
    return '<h2 class="chihoi-login-title">CỔNG QUẢN TRỊ WEBSITE</h2>' . $message;
});
...
add_action('login_enqueue_scripts', function() {
    ...
    <style type="text/css">
        ...
        /* Các liên kết bên dưới form (#nav & ẩn hoàn toàn #backtoblog theo yêu cầu) */
        #login #nav {
            padding: 0 !important;
