...
document.addEventListener('DOMContentLoaded', () => {
  ...
  /* ── INTERACTIVE SVG MAP (Slide 6, 12, 13) ───────────────────── */
  const mapZones = {
    cih: {
      title: '🏥 City International Hospital (CIH)',
      status: 'active',
      statusLabel: '✅ Đang hoạt động',
      desc: 'Bệnh viện đa khoa chuẩn quốc tế đầu tiên tại khu y tế. Được chứng nhận chất lượng điều trị chuẩn Hoa Kỳ AACI vào năm 2023. Quy mô 320 giường bệnh với đầy đủ trang thiết bị chẩn đoán hiện đại bậc nhất.',
      stats: [
        { label: 'Website', value: 'cih.com.vn' },
        { label: 'Quy mô', value: '320 Giường bệnh' },
        { label: 'Accreditation', value: 'AACI (Hoa Kỳ)' }
      ]
    },
    giaan: {
      ...
      status: 'active',
      statusLabel: '✅ Đang hoạt động',
      desc: 'Bệnh viện đa khoa chuyên sâu về tim mạch, thần kinh đột quỵ, cơ xương khớp. Mô hình hợp tác công tư (PPP) tiên phong tại Việt Nam, liên kết trực tiếp với Bệnh viện Nhân dân 115 đầu ngành.',
      stats: [
        { label: 'Website', value: 'giaan115.com' },
        { label: 'Giải thưởng', value: 'Healthcare Asia 2023' },
        { label: 'Hợp tác công tư', value: 'PPP đầu tiên' }
      ]
    },
    stemcell: {
      title: '🔬 Trung Tâm Tế Bào Gốc',
      status: 'building',
      statusLabel: '⚙️ Đang xây dựng',
      desc: 'Dự án trọng điểm chuyển giao công nghệ điều trị tế bào thế hệ mới, hợp tác nghiên cứu lâm sàng cùng các viện công nghệ sinh học hàng đầu của Nhật Bản (Cyto-Facto) và Hàn Quốc.',
      stats: [
        { label: 'Đối tác', value: 'Cyto-Facto (Nhật Bản)' },
        { label: 'Trạng thái', value: 'Hoàn thiện mặt bằng' },
        { label: 'Hoàn thành dự kiến', value: 'Q4/2027' }
      ]
    },
    hospital3: {
      title: '🏥 Bệnh Viện Chuyên Khoa 3 (Tim Mạch / Ung Bướu)',
      status: 'invest',
      statusLabel: '💰 Kêu gọi đầu tư',
      desc: 'Dự án bệnh viện chuyên khoa chất lượng cao với quy mô 200 giường. Đang tìm kiếm đối tác liên doanh đầu tư tài chính, trang thiết bị và quản lý vận hành y tế từ nước ngoài.',
      stats: [
        { label: 'Quỹ đất', value: 'Hơn 12.000 m²' },
        { label: 'Hình thức', value: 'Liên doanh / 100% Vốn' },
        { label: 'Công suất thiết kế', value: '250 Giường' }
      ]
    },
    research: {
      title: '🎓 Khu Nghiên Cứu & Đào Tạo Y Khoa',
      status: 'planned',
      statusLabel: '📋 Đã quy hoạch',
      desc: 'Khu phức hợp trường đại học y dược, thư viện y học điện tử, trung tâm hội nghị quốc tế và phòng lab nghiên cứu thực nghiệm, đào tạo nguồn nhân lực chất lượng cao cho toàn hệ sinh thái.',
      stats: [
        { label: 'Quy mô diện tích', value: 'Hơn 4,5 ha' },
        { label: 'Đối tác tiềm năng', value: 'Đại học Y Dược TP.HCM' },
        { label: 'Lộ trình triển khai', value: 'Giai đoạn 2028 - 2030' }
      ]
    },
    hospitals456: {
      title: '🏥 Phân Khu Bệnh Viện Chuyên Khoa 4 - 5 - 6',
      status: 'planned',
      statusLabel: '📋 Quy hoạch',
      desc: 'Quy hoạch ba bệnh viện chuyên khoa tiếp theo trong khuôn viên 37,5 ha bao gồm: Bệnh viện Nhi đồng, Bệnh viện Phụ sản và Bệnh viện Lão khoa quốc tế. Đáp ứng tối đa nhu cầu chăm sóc sức khỏe trọn vòng đời.',
      stats: [
        { label: 'Tổng số giường', value: '900 Giường dự kiến' },
        { label: 'Lộ trình', value: 'Sau năm 2026' }
      ]
    },
    commercial: {
      title: '🛍️ AEON Mall Bình Tân & Dịch Vụ',
      status: 'active',
      statusLabel: '✅ Đang hoạt động',
      desc: 'Trung tâm thương mại lớn AEON Mall Bình Tân, căn hộ dịch vụ dành cho chuyên gia, trường mầm non quốc tế tạo nên một hệ sinh thái tiện ích, dịch vụ hỗ trợ cao cấp bao quanh khu y tế.',
      stats: [
        { label: 'Diện tích sàn', value: '110.000 m²' },
        { label: 'Đối tác', value: 'Tập đoàn AEON (Nhật Bản)' }
      ]
    },
    rehab: {
      title: '🏥 Bệnh Viện Phục Hồi Chức Năng & Dưỡng Lão',
      status: 'invest',
      statusLabel: '💰 Kêu gọi đầu tư',
      desc: 'Dự án chăm sóc giảm nhẹ và điều trị vật lý trị liệu chất lượng cao cho người cao tuổi. Cơ hội đầu tư đón đầu xu thế già hóa dân số với mô hình nghỉ dưỡng dưỡng lão cao cấp kết hợp y tế chuyên sâu.',
      stats: [
        { label: 'Quy mô', value: '150 Giường' },
        { label: 'Hình thức', value: 'BOT / Hợp tác đầu tư' }
      ]
    }
  };
  ...
  function renderZoneDetails(zoneId) {
    ...
    mdStatus.style.borderColor = color;
    mdStatus.style.color = color;
    mdStatus.style.background = color + '12';

    mdDesc.textContent = data.desc;

    // Render Stats list
    mdStats.innerHTML = data.stats.map(s => `
      <div class="md-stat-row">
        <span class="md-stat-label">${s.label}</span>
        <span class="md-stat-val">${s.value}</span>
      </div>
    `).join('');

    mdCta.style.display = 'inline-flex';
  }

  // Pre-load CIH on load
  renderZoneDetails('cih');
