          ...
          <div class="news-card-body">
            <div>
              ...
              <p style="font-size:0.85rem;color:#64748b;line-height:1.5;">
                Chuẩn y danh sách 24 thành viên Ban Chấp hành và 15 thành viên Ban Thư ký Chi hội Bệnh viện Tư nhân TP.HCM và các tỉnh thành phía Nam nhiệm kỳ 2026 – 2029.
              </p>
            </div>
        ...
        <div class="news-article-card" data-category="su-kien">
          ...
          <div class="news-card-body">
            <div>
              ...
              <p style="font-size:0.85rem;color:#64748b;line-height:1.5;">
                Ngày 19/8/2026 tại Bệnh viện Quốc tế City, Hiệp hội Bệnh viện Tư nhân Việt Nam tổ chức Lễ ra mắt Ban Chấp hành Chi hội phía Nam. Madam Trần Thị Lâm được bầu làm Chủ tịch Chi hội.
              </p>
            </div>
            <div class="news-card-footer">
        ...
        <div class="news-article-card" data-category="chi-hoi">
          ...
          <div class="news-card-body">
            <div>
              ...
              <p style="font-size:0.85rem;color:#64748b;line-height:1.5;">
                TS.BS. Hà Anh Đức – Cục trưởng Cục Quản lý Khám, chữa bệnh (Bộ Y tế) đánh giá cao sự lớn mạnh và đóng góp quan trọng của hệ thống bệnh viện ngoài công lập.
              </p>
            </div>
            <div class="news-card-footer">
        ...
        <div class="news-article-card" data-category="chi-hoi">
          ...
          <div class="news-card-body">
            <div>
              ...
              <p style="font-size:0.85rem;color:#64748b;line-height:1.5;">
                Chủ tịch Hiệp hội Bệnh viện Tư nhân Việt Nam định hướng công tác liên kết đào tạo, nghiên cứu khoa học và bảo vệ quyền lợi chính đáng cho các hội viên.
              </p>
            </div>
            <div class="news-card-footer">
        ...
        <div class="news-article-card" data-category="chi-hoi">
          ...
          <div class="news-card-body">
            <div>
              ...
              <p style="font-size:0.85rem;color:#64748b;line-height:1.5;">
                Chương trình chuẩn Bộ Y tế phối hợp cùng các viện nghiên cứu, trường đại học y dược và các bệnh viện thành viên phía Nam.
              </p>
            </div>
            <div class="news-card-footer">
        ...
        <div class="news-article-card" data-category="su-kien">
          ...
          <div class="news-card-body">
            <div>
              ...
              <p style="font-size:0.85rem;color:#64748b;line-height:1.5;">
                Thiết lập hệ thống hội chẩn trực tuyến hỗ trợ chuyển giao kỹ thuật và xử lý các ca bệnh phức tạp giữa các bệnh viện trong mạng lưới.
              </p>
            </div>
            <div class="news-card-footer">
        ...
        <div class="news-article-card" data-category="y-hoc">
          ...
          <div class="news-card-body">
            <div>
              ...
              <p style="font-size:0.85rem;color:#64748b;line-height:1.5;">
                Khuyến cáo chuyên môn của Hội đồng Y khoa Chi hội về tầm quan trọng của việc chủ động tầm soát và can thiệp điều trị bảo tồn chức năng cơ quan.
              </p>
            </div>
            <div class="news-card-footer">
