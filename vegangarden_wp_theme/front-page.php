...
<!-- HERO BANNER SECTION -->
  ...
  <section class="section-highlights" id="speisekarte">
    <div class="container">
      ...
      <a href="<?php echo esc_url($pdf_url); ?>" target="_blank" rel="noopener" class="btn btn-primary" style="margin-top: 32px; display: inline-flex; align-items: center; justify-content: center; gap: 8px;">
