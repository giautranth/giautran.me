  ...
  <div class="container">
    ...
    <div class="white-box-card" style="margin-top: 24px; padding: 40px; border-radius: 16px;">
      ...
      <div class="hiep-hoi-footer-section" style="margin-top: 36px; padding-top: 28px; border-top: 1.5px solid #e2e8f0;">
        ...
        <div class="hiep-hoi-contact-grid" style="display: grid; grid-template-columns: repeat(2, 1fr); gap: 16px; background: #f8fafc; border: 1px solid #e2e8f0; border-radius: 12px; padding: 20px 24px;">
          
          <div style="display: flex; align-items: flex-start; gap: 10px; font-size: 0.98rem; color: #334155; line-height: 1.6; grid-column: 1 / -1;">
          ...
          <div style="display: flex; align-items: center; gap: 10px; font-size: 0.98rem; color: #334155;">
