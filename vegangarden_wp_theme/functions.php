...
function vegangarden_scripts() {
    ...
    // Main Stylesheet
    wp_enqueue_style('vegangarden-main', get_template_directory_uri() . '/styles.css', array(), '20260918_03');
    wp_enqueue_style('vegangarden-theme', get_stylesheet_uri(), array('vegangarden-main'), '1.0.3');

    // Main Script
    wp_enqueue_script('vegangarden-script', get_template_directory_uri() . '/script.js', array(), '20260918_02', true);
}
